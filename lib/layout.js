...
.section-wrap { max-width: 1200px; margin: 0 auto; padding: 140px 5vw 100px; }
...
.blog-search-form input:focus { border-color: var(--vivid-green); box-shadow: 0 0 0 3px rgba(112,182,44,0.15); }
...
.blog-card-meta { font-size: 0.75rem; color: rgba(255,255,255,0.4); margin-top: auto; }
...
.cookie-btn-reject { background: transparent; color: rgba(255,255,255,0.45); border: 1px solid rgba(255,255,255,0.12); border-radius: 8px; padding: 0.55rem 1.25rem; font-family: inherit; font-size: 0.82rem; cursor: pointer; transition: border-color 0.2s, color 0.2s; }
...
<nav id="main-nav">
  ...
  <div class="hamburger" id="hamburger" aria-label="Menú" role="button" tabindex="0"><span></span><span></span><span></span></div>
</nav>`;
}
...
function renderPage({ title, description, canonicalPath, ogImage, activePath, bodyHtml, jsonLd, robots }) {
